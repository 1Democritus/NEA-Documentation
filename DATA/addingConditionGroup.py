...
blocks = [
    ...
    ('K25','K28','Gastric and duodenal ulcers'),
    ('K29','K29','Gastritis and duodenitis'),
    ('K30','K31','Other diseases of stomach and duodenum'),
    ...
    ('O80','O84','Encounter for delivery'),
    ...
    ('P70','P74','Transient endocrine and metabolic disorders specific to fetus and newborn'),
    ...
    ('R20','R23','Symptoms and signs involving the skin and subcutaneous tissue'), # Corrected end of block
...
df = pandas.read_csv("NEAtrainset.csv")
df["Condition Group"] = ""
condition = ''
idx = 0
for i in range(len(df)):
    try:
        if df["ICD Code"][i] == blocks[idx][0]:
            print(condition, df["ICD Code"][i])
            condition = blocks[idx][2]
            idx += 1
    except:
        pass
    df["Condition Group"][i] = condition
