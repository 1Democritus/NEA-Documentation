...
'''
    ...
    def addAppointment(self):
        ...
        self.STAFFdateLabel = Label(self.screen, text = "Date, in the format dd/mm/yyyy", wraplength = 250)
        ...
        self.STAFFtimeLabel = Label(self.screen, text = "Time, in the format hh:mm:ss", wraplength = 250)
